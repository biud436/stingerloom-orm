...
- `INTEGRATION_TEST=true` 환경변수 필요 (MySQL/PostgreSQL/SQLite 실제 연결)
- `multi-tenancy-postgres.test.ts` — PostgreSQL 스키마 기반 멀티테넌시
...
- `sqlite/sync-modes.test.ts` — synchronize true/safe/dry-run 통합 테스트
